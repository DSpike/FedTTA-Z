...
class SystemConfig:
    ...
    # ==================================================================================
    use_category_grouping: bool = False  # Default: Fine-grained evaluation (harder, more impressive)
    ...
    zero_day_attack: str = "neptune"  # Common DoS attack for zero-day testing
    ...
    def zero_day_attack_label(self) -> int:
        ...
        if self.use_category_grouping and self.category_types:
            # Grouped mode: Return category label
