    ...
    def preprocess_unsw_dataset(self, zero_day_attack: str = 'PortScan') -> dict:
        ...
        if len(test_df) > MAX_TEST_SAMPLES:
            ...
            if 'Label' in test_df.columns:
                ...
                samples_per_class = MAX_TEST_SAMPLES // len(unique_labels)
                ...
                benign_samples = int(MAX_TEST_SAMPLES * 0.4)
                attack_samples = MAX_TEST_SAMPLES - benign_samples
                
                sampled_dfs = []
                
                # Sample BENIGN
                if 'BENIGN' in unique_labels:
                    benign_df = test_df[test_df['Label'] == 'BENIGN']
